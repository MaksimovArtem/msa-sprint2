...
type BookingServiceClient interface {
	...
	ListBookings(ctx context.Context, in *BookingListRequest, opts ...grpc.CallOption) (*BookingListResponse, error)
}
...
func (c *bookingServiceClient) ListBookings(ctx context.Context, in *BookingListRequest, opts ...grpc.CallOption) (*BookingListResponse, error) {
...
type BookingServiceServer interface {
	...
	ListBookings(context.Context, *BookingListRequest) (*BookingListResponse, error)
...
func (UnimplementedBookingServiceServer) ListBookings(context.Context, *BookingListRequest) (*BookingListResponse, error) {
...
func _BookingService_ListBookings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).ListBookings(ctx, req.(*BookingListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
